...
/**
 * Команда предназначенная для отображения главной страницы администратора
 * 
...
public class GetAdministratorInfoCommand implements Command {
	...
	private static final Logger log = LogManager.getLogger(GetAdministratorInfoCommand.class);
